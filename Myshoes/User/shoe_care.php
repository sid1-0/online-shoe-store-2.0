...
<head>
    ...
    <title>Shoe Care Collection - My Family Store</title>
    <style>
        /* Reset */
        * {
...
<body>
    <div class="puma-hero" style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8), rgba(46, 204, 113, 0.8)), url('../shoeImage/shoes.jpg'); background-size: cover; background-position: center;">
        <div class="puma-hero-content">
            <div class="puma-logo">✨</div>
            <h1>Shoe Care Collection</h1>
            <p>Keep your footwear looking brand new with our premium selection of cleaners, protectors, and accessories.</p>
        </div>
    </div>

    <div class="container">
        <div class="brand-description">
            <h2>Ultimate Shoe Protection</h2>
            <p>
                Extend the life of your favorite shoes with our specialized care products. From deep-cleaning foams to crease protectors and water-repellent sprays, we have everything you need to maintain that fresh-out-of-the-box look.
            </p>
        </div>
        ...
        <div class="shoes-grid">
            ...
            $stmt = $connection->prepare("SELECT shoe_id, name, price, original_price, image_col, status, brand FROM shoes WHERE name LIKE '%cleaner%' OR name LIKE '%protect%' OR name LIKE '%spray%' OR name LIKE '%tree%'");
            $stmt->execute();
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<div class="empty-state">
                        ...
                        <h3>No Shoe Care Products Found</h3>
                        <p>We couldn\'t find any shoe care products at the moment. Check back later or browse our amazing shoe collection.</p>
