...
<head>
    ...
    <title>All Products - My Shoe Store</title>
    <style>
        /* Reset */
        * {
        ...
        .all-hero {
            background: linear-gradient(135deg, rgba(0, 0, 0, 0.8), rgba(102, 126, 234, 0.8)), url('images/shoes.jpg');
        ...
        .shoe:nth-child(2) { animation-delay: 0.15s; }
        .shoe:nth-child(3) { animation-delay: 0.2s; }
        .shoe:nth-child(4) { animation-delay: 0.25s; }
        .shoe:nth-child(5) { animation-delay: 0.3s; }
        .shoe:nth-child(6) { animation-delay: 0.35s; }
        .shoe:nth-child(7) { animation-delay: 0.4s; }
        .shoe:nth-child(8) { animation-delay: 0.45s; }
...
<body>
    <div class="all-hero">
        <div class="all-hero-content">
            <div class="all-hero-icon">👟</div>
            <h1>All Products</h1>
            <p>Browse our complete collection of premium footwear, socks, and shoe care products. Find the perfect items that match your style and needs.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="brand-description">
            ...
            <p>
                Explore everything we offer — shoes from Nike, Adidas, and Puma, plus socks, shoe care products, and more. 
                Filter by brand, price, or availability to find exactly what you're looking for.
            </p>
        </div>
            ...
            <div class="filter-bar">
                <div class="filter-options">
                    ...
                    <select class="filter-select">
                        ...
                        <option>Rs 5000 - Rs 15000</option>
                        <option>Over Rs 15000</option>
                    </select>
                </div>
        ...
        <div class="shoes-grid">
            ...
            $stmt = $connection->prepare("SELECT shoe_id, name, price, original_price, image_col, status, brand FROM shoes ORDER BY created_at DESC");
            $stmt->execute();
            ...
            if ($result->num_rows > 0) {
                    ...
                    <div class="shoe" onclick="window.location.href='shoe_details.php?shoe_id=<?php echo $shoeId; ?>'">
                        ...
                        <div class="shoe-details">
                            <div>
                                ...
                                <div class="shoe-meta">
                                    <span class="shoe-brand"><?php echo $brandName; ?></span>
                            ...
                            <div class="shoe-actions">
                                ...
                                <button class="action-btn wishlist-btn-card" onclick="event.stopPropagation(); toggleWishlist(<?php echo $shoeId; ?>, this)">Add to Wishlist</button>
                            </div>
                        </div>
                    </div>
                    <?php
                ...
                echo '<div class="empty-state">
                        ...
                        <p>We couldn\'t find any products at the moment. Check back later!</p>
                        <a href="index.php" class="browse-all-btn">Back to Home</a>
                      </div>';
            }
