...
<head>
    ...
    <title>Adidas Collection - My Family Store</title>
    <style>
        /* Reset */
        * {
        ...
        .adidas-hero {
            background: linear-gradient(135deg, rgba(0, 0, 0, 0.8), rgba(0, 98, 190, 0.8)), url('/placeholder.svg?height=400&width=1200');
        ...
        .adidas-hero::before {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(45deg, #0062be, #00a2ff, #87ceeb);
            opacity: 0.1;
        ...
        .adidas-stripes {
            ...
            gap: 8px;
            margin-bottom: 20px;
            animation: stripesFloat 3s ease-in-out infinite;
        }
        ...
        .brand-description::before {
            ...
            right: 0;
            height: 5px;
            background: linear-gradient(90deg, #0062be, #00a2ff, #87ceeb);
        }
        ...
        .brand-description h2::after {
            ...
            width: 80px;
            height: 4px;
            background: linear-gradient(90deg, #0062be, #00a2ff);
            border-radius: 2px;
        }
        ...
        .filter-select:focus {
            outline: none;
            border-color: #0062be;
            box-shadow: 0 0 0 3px rgba(0, 98, 190, 0.1);
        }
        ...
        .shoe-badge {
            ...
            top: 15px;
            right: 15px;
            background: linear-gradient(45deg, #0062be, #00a2ff);
            color: white;
            padding: 8px 15px;
            border-radius: 20px;
            font-size: 0.8rem;
        ...
        .view-btn-action:hover {
            ...
            box-shadow: 0 8px 15px rgba(0, 98, 190, 0.4);
        }
        ...
        .browse-all-btn:hover {
            ...
            box-shadow: 0 15px 30px rgba(0, 98, 190, 0.4);
        }
        ...
        .page-item:hover {
            ...
            color: white;
            transform: translateY(-3px);
            box-shadow: 0 10px 20px rgba(0, 98, 190, 0.3);
        }
...
<body>
    <div class="adidas-hero">
        <div class="adidas-hero-content">
            ...
            <p>Impossible is Nothing. Explore the latest Adidas footwear featuring cutting-edge technology and timeless design for athletes and style enthusiasts.</p>
        </div>
    </div>

    <div class="container">
        <div class="brand-description">
            <h2>Adidas - Performance Meets Style</h2>
            <p>
                Step into excellence with Adidas' revolutionary footwear collection. From Boost cushioning to Primeknit uppers, 
                every shoe is crafted with precision engineering and innovative materials. Whether you're training for your next PR, 
                dominating the field, or making a statement on the streets, Adidas empowers you to achieve the impossible.
            </p>
        </div>
        ...
        <div class="shoes-grid">
            ...
            $brandToFilter = "Adidas";

            $stmt = $connection->prepare("SELECT shoe_id, name, price, image_col, status FROM shoes WHERE brand = ?");
            $stmt->bind_param("s", $brandToFilter);
            $stmt->execute();
            ...
            if ($result->num_rows > 0) {
                    ...
                    <div class="shoe" onclick="window.location.href='shoe_details.php?shoe_id=<?php echo $shoeId; ?>'">
                        ...
                        <div class="shoe-details">
                            <div>
                                ...
                                <div class="shoe-meta">
                                    <span class="shoe-brand">Adidas</span>
                                    <span class="price">Rs <?php echo $shoePrice; ?></span>
                                </div>
                ...
                echo '<div class="empty-state">
                        ...
                        <h3>No Adidas Shoes Found</h3>
                        <p>We couldn\'t find any Adidas shoes at the moment. Check back later or browse our other amazing brands.</p>
                        <a href="index.php" class="browse-all-btn">Browse All Shoes</a>
                      </div>';
            }
