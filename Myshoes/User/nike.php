...
<head>
    ...
    <title>Nike Collection - My Family Store</title>
    <style>
        /* Reset */
        * {
        ...
        .nike-hero {
            background: linear-gradient(135deg, rgba(0, 0, 0, 0.8), rgba(255, 87, 34, 0.8)), url('/placeholder.svg?height=400&width=1200');
        ...
        .nike-swoosh {
            font-size: 6rem;
            margin-bottom: 20px;
            animation: swooshFloat 3s ease-in-out infinite;
        }
...
<body>
    <div class="nike-hero">
        <div class="nike-hero-content">
            <div class="nike-swoosh">✓</div>
            <h1>Nike Collection</h1>
            <p>Just Do It. Discover the latest Nike footwear combining innovative technology with iconic style for athletes and enthusiasts worldwide.</p>
        </div>
    </div>

    <div class="container">
        <div class="brand-description">
            <h2>Nike - Innovation in Motion</h2>
            <p>
                Experience the pinnacle of athletic footwear with Nike's cutting-edge designs. From Air Max cushioning to Flyknit technology, 
                every pair is engineered for performance, comfort, and style. Whether you're hitting the track, the court, or the streets, 
                Nike delivers the innovation you need to push your limits.
            </p>
        </div>
        ...
        <div class="shoes-grid">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<div class="empty-state">
                        ...
                        <h3>No Nike Shoes Found</h3>
                        <p>We couldn\'t find any Nike shoes at the moment. Check back later or browse our other amazing brands.</p>
