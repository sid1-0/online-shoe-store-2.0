...
<head>
    ...
    <title>Puma Collection - My Family Store</title>
    <style>
        /* Reset */
        * {
...
<body>
    <div class="puma-hero">
        <div class="puma-hero-content">
            ...
            <p>Forever Faster. Discover Puma's innovative athletic footwear designed for speed, agility, and style. From running tracks to city streets.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="brand-description">
            ...
            <p>
                Step into the world of speed and performance with Puma's cutting-edge athletic footwear. Known for their innovative designs 
                and superior comfort technology, Puma shoes are engineered for athletes who demand excellence. Whether you're sprinting on the track 
                or making a statement on the street, Puma delivers the perfect blend of performance and style.
            </p>
        </div>
        ...
        <div class="shoes-grid">
            ...
            if ($result->num_rows > 0) {
                    ...
                    <div class="shoe" onclick="window.location.href='shoe_details.php?shoe_id=<?php echo $shoeId; ?>'">
                        ...
                        <div class="shoe-details">
                            <div>
                                ...
                                <div class="shoe-meta">
                                    <span class="shoe-brand">Puma</span>
                ...
                echo '<div class="empty-state">
                        ...
                        <h3>No Puma Shoes Found</h3>
                        <p>We couldn\'t find any Puma shoes at the moment. Check back later or browse our other amazing brands.</p>
